...
use CCDNForum\ForumBundle\Form\Type\Admin\Board\BoardCreateFormType as BaseBoardCreateFormType;
use Doctrine\ORM\EntityRepository;
use Symfony\Component\Form\FormBuilderInterface;

class BoardCreateFormType extends BaseBoardCreateFormType
{
    /**
     * {@inheritdoc}
     */
                    ...
                    'query_builder' =>
                        function (EntityRepository $er) {
                            return $er
                                ...
                                ->leftJoin('c.forum', 'f')//->groupBy('c.forum')
                                ;
                        },
